...
void resize_summary_model(WindowModel *summary_model, int screen_h, int screen_w, bool is_small_width) {
    ...
    summary_model->is_hidden = is_small_width;
}
